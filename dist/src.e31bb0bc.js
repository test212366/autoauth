...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"moduls/utils.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.autorizatonForm = exports.regustration = exports.change = void 0;
...
exports.regustration = regustration;

const autorizatonForm = async () => {
...
exports.autorizatonForm = autorizatonForm;
...
var _utils = require("./moduls/utils");
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  $formReg.addEventListener('submit', e => {
    e.preventDefault();
    (0, _utils.regustration)();
  });
  $autorizationForm.addEventListener('submit', e => {
    e.preventDefault();
    (0, _utils.autorizatonForm)();
  });
});
},{"./moduls/utils":"moduls/utils.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
